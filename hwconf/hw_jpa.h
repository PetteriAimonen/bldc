...
// Macros
#define ENABLE_GATE()			palSetPad(GPIOB, 4)
#define DISABLE_GATE()			palClearPad(GPIOB, 4)
#define DCCAL_ON()				palSetPad(GPIOA, 15)
#define DCCAL_OFF()				palClearPad(GPIOA, 15)
